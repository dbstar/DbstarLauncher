...
public class GDDataProviderService extends Service {
	...
	public static final int REQUESTTYPE_GETDESCRIPTION = 3;
	public static final int REQUESTTYPE_GETIMAGE = 4;
	public static final int REQUESTTYPE_GETDETAILSDATA = 5;
	public static final int REQUESTTYPE_GETDOWNLOADSTATUS = 6;
	
	public static final int REQUESTTYPE_GETPOWERCONSUMPTION = 7;
	public static final int REQUESTTYPE_GETTOTALCOSTBYCHARGETYPE = 8;
	public static final int REQUESTTYPE_GETWEATHER = 9;
	
	public static final int REQUESTTYPE_SETSETTINGS = 10;
	public static final int REQUESTTYPE_GETSETTINGS = 11;
	...
	GDWeatherDataAccessor mWeatherDataAccessor;
	...
	public void onCreate() {
		...
		mWeatherDataAccessor = new GDWeatherDataAccessor(mDataAccessor.getWeatherCityCodeBDFile());
	...
	private class WorkerThread extends Thread {
		...
		private void taskFinished(RequestTask task) {
			Log.d(TAG, "Task [" + task.Id + "] Finished - Thread Id [" + mThreadId + "]");
		...
		public void run() {
			...
			while (true) {
				...
				case REQUESTTYPE_GETDOWNLOADSTATUS: {
					ReceiveEntry[] entries = mModel.getDownloadStatus(task.PageNumber, task.PageSize);
					task.Data = entries;
					taskFinished(task);
					break;
				}
				...
				case REQUESTTYPE_GETPOWERCONSUMPTION: {
					...
					String powerConsumption = mNetModel.getPowerConsumption(cc_id, date_start, date_end);
				...
				case REQUESTTYPE_GETTOTALCOSTBYCHARGETYPE: {
					...
					String totalCost = mNetModel.getTotalCostByChargeType(cc_id, date_start, date_end, charge_type);
					task.Data = totalCost;
				...
				case REQUESTTYPE_GETWEATHER: {
					WeatherData data = mWeatherDataAccessor.getWeatherData((String)task.Key);
					task.Data = data;
					taskFinished(task);
					break;
				}
	...
	public void getDownloadStatus(ClientObserver observer, int pageNumber, int pageSize) {
		RequestTask task = new RequestTask();
		task.Id = System.currentTimeMillis();
		task.Observer = observer;
	...
	public void getPowerConsumption(ClientObserver observer, String cc_id, String date_start, String date_end) {
		if (!mNetworkIsReady)
			return;
	...
	public void getTotalCostByChargeType(ClientObserver observer, String cc_id, String date_start, String date_end, String charge_type) {
		if (!mNetworkIsReady)
			return;
	...
	private BroadcastReceiver mUSBReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(Intent.ACTION_MEDIA_MOUNTED)) {
				Message message = mHandler.obtainMessage(GDCommon.MSG_MEDIA_MOUNTED);
			...
			/* ||action.equals(Intent.ACTION_MEDIA_UNMOUNTED) */) {
				...
				Message message = mHandler.obtainMessage(GDCommon.MSG_MEDIA_REMOVED);
				Bundle data = new Bundle();
				data.putString("disk", uri.getPath());
				message.setData(data);
	...
	private BroadcastReceiver mNetworkReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			//case 1: attempting to connect to another network, just wait for another broadcast
			//case 2: connected
